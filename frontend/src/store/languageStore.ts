...
export const translations: Record<string, Translations> = {
  tr: {
    ...
    'heroTitle1': 'Yeni Nesil Dijital Otelcilik',
    'heroTitle2': 'Misafir Mutluluğu & Yüksek Kâr',
    'heroTitle3': 'Geleceğin Operasyonel Gücü',
    'heroSubtitle1': 'Lüksü dijitalle buluşturun. Misafirleriniz her şeye tek tıkla ulaşırken, operasyonunuz kusursuz işlesin.',
    'heroSubtitle2': 'Resepsiyon trafiğini bitirin; %35 operasyonel hız artışı ve %40\'a varan ek gelir artışı ile otelinizi geleceğe taşıyın.',
  ...
  en: {
    ...
    'heroTitle1': 'Next-Gen Digital Hospitality',
    'heroTitle2': 'Guest Happiness & High Profit',
    'heroTitle3': 'Operation Power of the Future',
    'heroSubtitle1': 'Meet luxury with digital. While your guests reach everything with one click, let your operation work flawlessly.',
    'heroSubtitle2': 'End reception traffic; move your hotel to the future with 35% operational speed increase and up to 40% extra revenue.',
  ...
  de: {
    ...
    'heroTitle1': 'Digitale Hotellerie der nächsten Generation',
    'heroTitle2': 'Gästeglück & Hoher Gewinn',
    'heroTitle3': 'Die Betriebskraft der Zukunft',
    'heroSubtitle1': 'Treffen Sie Luxus auf digitalem Weg. Während Ihre Gäste alles mit einem Klick erreichen, lassen Sie Ihren Betrieb fehlerfrei arbeiten.',
    'heroSubtitle2': 'Beenden Sie den Rezeptionsverkehr; Bringen Sie Ihr Hotel mit einer Steigerung des Betriebstempos um 35 % und einer Steigerung des Zusatzumsatzes um bis von 40 % in die Zukunft.',
