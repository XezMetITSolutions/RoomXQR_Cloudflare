...
export const translations: Record<string, Translations> = {
  tr: {
    ...
    'noChangeTitle': 'HIZLI GEÇİŞ SÜRECİ',
    'noChangeSubtitle': 'Hızlı Geçiş Süreci',
    'noChangeDesc': 'Otel bilgilerinizi yükleyin, QR kodları yerleştirin ve operasyonel verimliliğe bugün başlayın.',
    'noChangeFooter': 'HEMEN BAŞLA',
    ...
    'faq1A': 'Misafirleriniz, kendi dillerinde otel içi tüm hizmetlerden anında haberdar olur, kolayca isteklerini iletir ve menüden istediği yemeği tek tıkla sipariş edebilir. Teslim süresi gibi detaylı bilgilere sahip olurken, otelin etkinliklerine katılım oranı da artar.',
    'faq2Q': 'Sistem operasyonu nasıl kolaylaştırır?',
    'faq2A': 'Misafirler resepsiyonu aramadan tüm taleplerini QR üzerinden görür veya ilgili birime iletir. Bu da telefon trafiğini %50 azaltır, dil bariyeri ve hız gibi sorunları ortadan kaldırarak memnuniyeti artırır. Misafirler otel imkanlarını daha aktif kullanmaya başlar.',
  ...
  en: {
    ...
    'noChangeTitle': 'QUICK TRANSITION PROCESS',
    'noChangeSubtitle': 'Quick Transition Process',
    'noChangeDesc': 'Upload your hotel information, place the QR codes, and start operational efficiency today.',
    'noChangeFooter': 'START NOW',
    ...
    'faq1A': 'Guests are instantly informed about all in-hotel services in their own language, can easily submit requests, and order food from the menu with one click. They get detailed info like delivery times, and engagement with hotel events increases.',
    'faq2Q': 'How does the system simplify operations?',
    'faq2A': 'Guests see and direct all requests via QR without calling the reception. This reduces phone traffic by 50%, eliminates language barriers and speed issues, increasing satisfaction. Guests start using hotel facilities more actively.',
  ...
  de: {
    ...
    'noChangeTitle': 'SCHNELLER ÜBERGANGSPROZESS',
    'noChangeSubtitle': 'Schneller Übergangsprozess',
    'noChangeDesc': 'Laden Sie Ihre Hotelinformationen hoch, platzieren Sie die QR-Codes und starten Sie noch heute mit der operativen Effizienz.',
    'noChangeFooter': 'JETZT STARTEN',
    ...
    'faq1A': 'Gäste werden in ihrer eigenen Sprache über alle Hotelservices informiert, können Anfragen einfach übermitteln und Speisen mit einem Klick bestellen. Sie erhalten detaillierte Infos wie Lieferzeiten, und die Beteiligung an Hotelaktivitäten steigt.',
    'faq2Q': 'Wie vereinfacht das System den Betrieb?',
    'faq2A': 'Gäste sehen und senden alle Anfragen über QR, ohne die Rezeption anzurufen. Dies reduziert den Telefonverkehr um 50 %, beseitigt Sprachbarrieren und beschleunigt Prozesse. Gäste nutzen die Hoteleinrichtungen aktiver.',
