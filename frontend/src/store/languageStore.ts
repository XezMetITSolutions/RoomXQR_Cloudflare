...
export const translations: Record<string, Translations> = {
  tr: {
    ...
    'heroSubtitle2': 'Resepsiyon telefon trafiğine son verin, otel içi restoran ve servis satışlarınızı %40\'a kadar artırın.',
  ...
  en: {
    ...
    'heroTitle3': 'The Operational Power of the Future',
    'heroSubtitle1': 'Merge luxury with digital. While your guests reach everything with one click, your operations run perfectly.',
    'heroSubtitle2': 'End reception phone traffic, increase your in-hotel restaurant and service sales by up to 40%.',
  ...
  de: {
    ...
    'heroTitle2': 'Gästezufriedenheit & hoher Gewinn',
    'heroTitle3': 'Die operative Kraft der Zukunft',
    'heroSubtitle1': 'Verbinden Sie Luxus mit Digitalem. Während Ihre Gäste alles mit einem Klick erreichen, läuft Ihr Betrieb perfekt.',
    'heroSubtitle2': 'Schluss mit dem Telefonverkehr an der Rezeption, steigern Sie Ihre Restaurant- und Serviceumsätze im Hotel um bis zu 40 %.',
