...
export const translations: Record<string, Translations> = {
  tr: {
    ...
    'marketingSectionSubtitle': 'QR Menü ve odaya hızlı sipariş ile otel restoran ve kafe kullanımınızı maksimuma çıkarın.',
  ...
  en: {
    ...
    'marketingSectionSubtitle': 'Maximize hotel restaurant and cafe usage with QR Menu and easy room ordering.',
  ...
  de: {
    ...
    'marketingSectionSubtitle': 'Maximieren Sie die Nutzung von Hotelrestaurants und -cafés mit QR-Menü und einfacher Zimmerbestellung.',
