...
export const translations: Record<string, Translations> = {
  tr: {
    ...
    'refundNote': '14 gün ücretsiz kullanım. 1 ay sonunda iade garantisi (Kurulum ücreti hariç)',
  ...
  en: {
    ...
    'refundNote': '14 days free trial. Money-back guarantee after 1 month (excluding setup fee)',
  ...
  de: {
    ...
    'refundNote': '14 Tage kostenlose Nutzung. Rückgabegarantie nach 1 Monat (außer Einrichtungsgebühr)',
